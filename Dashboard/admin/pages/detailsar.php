...
if (isset($_SESSION['admin'])) {
    ...
    $cas1=0;
      ...
      if(isset($_POST['Accepter'])){
                        ...
                        $query="update documentdepose set STATUS=1  where IDDOCDEPO='".$_GET['id']."' ";
      ...
      if(isset($_POST['Rejeter'])){
        ...
        $query="update documentdepose set STATUS=2  where IDDOCDEPO='".$_GET['id']."' ";
        $res1=$conex->query($query);
        $cas1=2;
                ...
                <div class="card">
                  <div class="card-body">
                    <form class="form-sample" action="" method="post" enctype="multipart/form-data" >
                      <?php include("../partials/_infosdepo.php")?>
